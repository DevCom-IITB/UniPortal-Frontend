<template>
  <div class="questions-page">
    ...
    <label class="feed-search">
      ...
      <input v-model="searchQuery" type="search" placeholder="Search" aria-label="Search answered questions" />
    </label>

    <div class="filter-row">
      <button type="button" class="filter-pill selected">Answered</button>
  ...
  methods: {
    ...
    async fetchQuestions() {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE}/question/answeredQ`,
        {
          method: "GET",
          headers: {
